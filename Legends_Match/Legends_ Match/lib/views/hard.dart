...
import 'package:flutter_memory_game/model/data3.dart' as data;
// ignore: unused_import
...
// ignore: unused_import
import 'package:flutter_memory_game/model/data3.dart';
import 'package:flutter_memory_game/views/game_over_screen.dart';
// ignore: unused_import

class HardDifficulty extends StatefulWidget {
  const HardDifficulty({super.key});

  @override
  State<HardDifficulty> createState() => _HardDifficulty();
}

class _HardDifficulty extends State<HardDifficulty> {
  ...
  void initializeGameData() {
    List shuffledImagePaths = data.createShuffledListFromImageSource3();
