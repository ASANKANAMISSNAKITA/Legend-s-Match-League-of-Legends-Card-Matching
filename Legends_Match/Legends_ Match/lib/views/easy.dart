...
import 'package:flutter_memory_game/model/data.dart' as data;
// ignore: unused_import
...
class EasyDifficulty extends StatefulWidget {
  const EasyDifficulty({super.key});

  @override
  State<EasyDifficulty> createState() => _EasyDifficultyState();
}

class _EasyDifficultyState extends State<EasyDifficulty> {
  ...
  void initializeGameData() {
    List shuffledImagePaths = data.createShuffledListFromImageSource();
    ...
    _time = 3;
    _left = shuffledImagePaths.length ~/ 2;
    _isFinished = false;
  }
